      ...
      <main className="pt-24 pb-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div>
              <h1 className="text-2xl sm:text-3xl font-display font-bold text-gray-900 mb-2">Owner Portal</h1>
              <p className="text-sm sm:text-base text-gray-600">Welcome back! View your property earnings and performance.</p>
            </div>
            <button className="px-4 sm:px-6 py-2 sm:py-3 bg-lime text-black font-semibold rounded-full hover:bg-lime-light transition-colors flex items-center gap-2 text-sm sm:text-base whitespace-nowrap">
